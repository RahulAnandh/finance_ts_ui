...
const DeployedFinances: React.FC = () => {
  const finance = useAppSelector((state) => state.finance);
  const dispatch = useAppDispatch();
  const [form] = Form.useForm();
  const [data, setData] = useState(finance.finance_list.not_deleted);
  const [editingKey, setEditingKey] = useState("");

  useEffect(() => {
    setData(finance.finance_list.not_deleted);
...
export default DeployedFinances;
